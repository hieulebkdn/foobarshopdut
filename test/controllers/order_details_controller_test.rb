...
#       post order_details_url, params: { order_detail: { price: @order_detail.price, quantity: @order_detail.quantity, shipday: @order_detail.shipday, status: @order_detail.status, userrequest: @order_detail.userrequest } }
#     end
...
#     patch order_detail_url(@order_detail), params: { order_detail: { price: @order_detail.price, quantity: @order_detail.quantity, shipday: @order_detail.shipday, status: @order_detail.status, userrequest: @order_detail.userrequest } }
