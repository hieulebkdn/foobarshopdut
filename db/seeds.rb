...
product_list = [
	...
	##### Products for APPLE
	[13,5,"Apple iPhone 8 Plus 4G LTE ",849.9,0.5,20,"Nano SIM, Fingerprint (front-mounted), accelerometer, gyro, proximity, compass, barometer, Apple A11 Bionic","Apple iPhone 8 Plus","Apple A11 Bionic","3GB","64GB","5.5\"\ ","None"],
	...
	[1,3,"Samsung Galaxy Note 8 Dual SIM ",834.9,0.2,10,"Exynos 8895 CPU, Octa-core (4 x 2.3 GHz & 4 x 1.7 GHz), Dual LED Rear Camera (12 MP+12 MP ) + 8 MP Front Camera","Samsung Smartphone","Exynos 8895","6GB","64GB","6.3\"\ 2960 x 1440","None"],
	...
	[1,3,"Samsung Galaxy S6 G920V 64GB ",279.9,0.2,16,"5.1-inch Super AMOLED Capacitive Touchscreen with Corning Gorilla Glass 4, Android OS, Exynos 7420 Octa Chipset, Octa-Core Processor","Samsung Smartphone","Exynos 7420 Octa","3GB","64GB","5.1\"\ 2560 x 1440","None"],
	#### Products for BLACKBERRY
	[1,4,"BlackBerry PRIV STV100-2 32GB ",219.9,0.2,20,"5.4-inch AMOLED Capacitive Touchscreen, Android v5.1, Qualcomm Snapdragon 808, Hexa-Core (4x1.4 GHz & 2x1.8 GHz) Processor, Adreno 418 GPU, 18 MP Camera + 2 MP Front Camera","BlackBerry Smartphone","Hexa-Core (Quad-Core 1.4 GHz Cortex-A53 & Dual-Core 1.8 GHz Cortex-A57)","3GB","32GB","1440 x 2560 pixels","None"],
	...
	[1,6,"HP Spectre x360 Premium Convertible 2-in-1",1549.9,2.1,10,"8th-Gen Intel Core i7-8550U (1.8GHz, 8MB cache) + NVIDIA GeForce MX150 2GB","HP Laptop","Intel Core i7","8 GB","256GB SSD","15.6\"\ UHD","NVIDIA GeForce MX150 Graphics 2GB"],
	...
	#### Products for SAMSUNG
	[9,3,"SAMSUNG Galaxy Tab S3 SM-T8 ",599,0.8,10,"9.7\"\ 2048 x 1536,Qualcomm APQ8096 (2.15 GHz)","SAMSUNG Tablet","Qualcomm APQ8096 (2.15 GHz)","4 GB","32 GB Flash Storage","9.7\"\ ","None"],
	...
	[6,1,"DELL Desktop Computer OptiPlex 305",599.9,3,10,"Dell Desktop", "Dell Desktop","Intel Core i7","16GB","1TB HDD","None","NVIDIA GTX1050Ti"],
	...
	[6,10,"MSI Desktop Computer Infinite ",1500,4,10,"MSI Desktop","MSI desktop","Intel corei7","32GB","1TB HDD + 256GB SSD","None","NVIDIA GTX1080Ti"],
